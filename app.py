...
if option == 'Stock Price Comparison':    
    #side bar
    ticker_input = st.sidebar.multiselect(label='Enter Tickers to Compare:', options=Company.get_tickers(), help='Choose multiple tickers to be compared')
...
if option == 'Portfolio Management':
    # sidebar
    ticker_input = st.sidebar.multiselect(label='Enter Tickers to Analyze', options=Company.get_tickers(), help='Choose Multiple Firms for Risk and Return')
